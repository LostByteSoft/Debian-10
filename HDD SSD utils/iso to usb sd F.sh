...
echo "Select and Write ISO to usb key : sdf"
echo -----------------------------------------------------------------------------

echo "Select filename using dialog"
FILE="$(zenity --file-selection --filename=$HOME/$USER --file-filter="*.iso" --title="Select a ISO File to write on SDF")"
